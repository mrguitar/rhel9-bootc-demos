...
ostreecontainer --url quay.io/cgwalters/ostest:rbase-dev        --no-signature-verification
#ostreecontainer --url quay.io/cgwalters/ostest:latest  --no-signature-verification

firewall --disabled
services --enabled=sshd
#rootpw --iscrypted locked
rootpw --iscrypted $6$Bph/wTBwpOOzPNaX$UIurNTYetaHyWMOW9Funhdrxi/cP91o7.roaiLdOh47IV/Tx.QpwHJZWRj6LFpaFyPRIjhhoQg7.CynILcAuQ0
